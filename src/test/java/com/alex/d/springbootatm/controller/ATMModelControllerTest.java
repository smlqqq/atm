...
//
//        ResponseEntity<DepositResponse> response = atmController.deposit(cardNumber, amount);
//
//        assertEquals(HttpStatus.OK, response.getStatusCode());
//        assertNotNull(response.getBody());
//        assertEquals(cardNumber, response.getBody().getCardNumber());
...
//        String nonExistentCardNumber = "1234567890123456"; // A card number you know does not exist
//
//        // Assuming the service is correctly set up and mocked
//        when(bankCardRepository.findByCardNumber(nonExistentCardNumber)).thenReturn(Optional.empty());
//
//        // Assert that CardNotFoundException is thrown
//        assertThrows(CardNotFoundException.class, () -> {
//            atmService.checkBalanceByCardNumber(nonExistentCardNumber);
//        });
//    }
//
//}